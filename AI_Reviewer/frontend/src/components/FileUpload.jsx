        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
                <div className="container px-5">
                    <a className="navbar-brand fw-bold" href="/">AI Reviewer</a>
                ...
                <div className="row gx-5 align-items-center">
                    <div className="col-lg-6">
                        <div className="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 className="display-1 lh-1 mb-3 fw-bold">Document Upload and Processing</h1>
                            <p className="lead fw-normal text-muted mb-5">Scan your pdf file to create a quiz reviewer with <br></br> multiple choices using Gemini AI, Quick and Easy!</p>
                            <div className="d-flex flex-column flex-lg-row align-items-center">
                                <a className="me-lg-3 mb-4 mb-lg-0" href="#!"><img className="app-badge" src="src/assets/app-store-badge.svg" alt="..." /></a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container px-5">
                <div className="row gx-5 align-items-center">
                    <div className="col-lg-5 order-lg-1 mb-5 mb-lg-0">
                        ...
                        <button onClick={toggleFeedbackModal} className="btn btn-outline mt-1">Give Feedback</button>
                    </div>
                    <div className="col-lg-7 order-lg-0">
                        <img className="app-badge" src="src/assets/feedback.png" alt="..." style={{ width: '85%' }} />
                    </div>
                </div>
            </div>
        </section>

            <div className={`modal fade ${showModal ? "show d-block" : ""}`} id="reviewerModal" tabIndex="-1" role="dialog" aria-labelledby="reviewerModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header bg-gradient-primary-to-secondary text-white">
                            <h5 className="modal-title" id="reviewerModalLabel">Provide Reviewer Info</h5>
                        </div>
                            ...
                            <div className="form-group">
                                ...
                                {preview && ( 
                                    <div className="thumbnail-preview">
                                        <label>Thumbnail Preview:</label><br></br>
                                        <img src={preview} alt="Thumbnail Preview" style={{ width: '100px', height: 'auto' }} /> 
                                    </div>
                                )}
                            </div>
                        </div>
